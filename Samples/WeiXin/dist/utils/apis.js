...
const QUNJI_HOST = 'https://www.jizuilv.cn';
...
export const Qunji = {
  // 域名
  HOST: QUNJI_HOST,
  TEST_URL: `${QUNJI_HOST}/parse`,
  Banner: `${QUNJI_HOST}/parse/GetBanner`,
  Articles: `${QUNJI_HOST}/parse/GetArticles`,
  GetArticlesByID: `${QUNJI_HOST}/parse/GetArticlesByID/`,
}

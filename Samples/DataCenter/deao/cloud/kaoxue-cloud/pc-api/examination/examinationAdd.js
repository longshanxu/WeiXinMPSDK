/**
 * @description 新增考试信息接口
 * @author mingcheng.feng
 * @since 2018-1-9
 */
Parse.Cloud.define("examinationadd",(request,response)=>{
    ...
    //考试信息
    var Examination = Parse.Object.extend('ExaminationInfo');
    var examination = new Examination ();

    //考试课程案例
    var examination_CourseCase_relation = examination.relation('examination_course_case');
    ...
    //考试班级
    var examination_Classes_relation = examination.relation('examination_classes');
    ...
    examination.set('examination_status',status);
    examination.set('examination_duration',Number(duration));
    examination.set('examination_title',title);
    examination.set('examination_begin_time',begin_time);
    examination.set('examination_end_time',end_time);
    examination.set('examination_school_id',school_id);
    examination.set('examination_cruces',cruces);
